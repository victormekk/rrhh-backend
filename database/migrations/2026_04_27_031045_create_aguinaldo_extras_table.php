...
{
    Schema::create('aguinaldo_extras', function (Blueprint $table) {
        $table->id();
        ...
        $table->decimal('diario', 10, 2)->nullable();
        $table->decimal('antiguedad', 10, 2)->nullable();
        $table->decimal('subtotal', 10, 2)->nullable();
        $table->integer('dias_promedio')->nullable();
        ...
        $table->string('tipo_aguinaldo', 10)->nullable();
    ...
    {
        Schema::dropIfExists('aguinaldo_extras');
    }
};
