...
<style>
  ...
  *:not(html):not(body) { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .header { text-align: center; border-bottom: 2px solid #3b2b16; padding-bottom: 10px; margin-bottom: 20px; }
  ...
  .firma-wrap   { margin-top: 60px; text-align: center; }
...
<div class="page">
  ...
  <div class="destinatario">
    ...
    <span class="val">{{ $banco->nombre }}</span>
  </div>
  ...
  <div class="cuerpo">
    ...
    <p>
      ...
      aperturar una cuenta de planilla a nombre del(la) empleado(a) antes mencionado(a), a fin de gestionar
      el pago de su salario a través de dicha institución bancaria.
    </p>
    <p>
